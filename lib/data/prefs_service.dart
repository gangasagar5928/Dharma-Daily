...
class PrefsService {
  ...
  static String get region =>
      _prefs.getString('panchang_region') ?? 'North India';
  ...
  static Future<void> setPanchangAlert(bool value) async =>
      await _prefs.setBool('panchang_alert', value);

  static bool get shlokaAlert => _prefs.getBool('shloka_alert') ?? true;
  static Future<void> setShlokaAlert(bool value) async =>
      await _prefs.setBool('shloka_alert', value);

  static bool get festivalAlert => _prefs.getBool('festival_alert') ?? true;
  static Future<void> setFestivalAlert(bool value) async =>
      await _prefs.setBool('festival_alert', value);

  // Theme Preference (0: System, 1: Dark, 2: Light)
  static int get themeModeIndex =>
      _prefs.getInt('theme_mode') ?? 1; // Default Dark
