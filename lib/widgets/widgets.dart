  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isDark ? Colors.amber.withValues(alpha: 0.4) : Colors.amber.shade700,
          width: 1.5,
        ),
        boxShadow: [
          BoxShadow(
            color: isDark ? Colors.black.withValues(alpha: 0.6) : Colors.amber.withValues(alpha: 0.15),
            blurRadius: 10,
            ...
            children: [
              Row(
                ...
                children: [
                  Row(
                    children: [
                      const Icon(Icons.calendar_today_outlined, color: Colors.amber, size: 20),
              ...
              Row(
                ...
                children: [
                  ...
                  _buildPanchangItem(context, 'Abhijit', panchang.abhijitMuhurta),
                ],
              ),
            ],
          ),
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: const Row(
                      children: [
                        Icon(Icons.science_outlined, size: 14, color: Colors.blueAccent),
                        SizedBox(width: 4),
                        Text('Scientific Logic Inside', style: TextStyle(fontSize: 11, color: Colors.blueAccent)),
                      ],
                    ),
                  ),
                  const Spacer(),
                  const Text('Read Ritual Details →', style: TextStyle(fontSize: 12, color: Colors.amber, fontWeight: FontWeight.bold)),
                ],
              ),
            ],
          ),
