...
class Verse {
  ...
  factory Verse.fromJson(Map<String, dynamic> json) {
    return Verse(
      number: json['verse_number'] ?? json['sutram_number'] ?? json['number'] ?? 0,
...
class Tradition {
  ...
  factory Tradition.fromJson(Map<String, dynamic> json) {
    return Tradition(
      ...
      historicalOriginHi: json['historical_origin_hi'] ?? json['historical_origin'] ?? '',
      scientificLogic: json['scientific_logic'] ?? '',
      scientificLogicHi: json['scientific_logic_hi'] ?? json['scientific_logic'] ?? '',
